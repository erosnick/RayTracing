...
int main(int argc, char** argv)
{
  ...
  // To build acceleration structures
  contextInfo.addDeviceExtension(VK_KHR_ACCELERATION_STRUCTURE_EXTENSION_NAME, false, &accelerationStructureFeature);
  ...
  // To use vkCmdTraceRayKHR
  contextInfo.addDeviceExtension(VK_KHR_RAY_TRACING_PIPELINE_EXTENSION_NAME, false, &rayTracingPipelineFeature);
